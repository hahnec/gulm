...
python ./pala_memgo+ellipse_gte+localize-2ch_script_dev_frame_batch.py ch_gap=${ch_gap} enlarge_factor=${enlarge_factor} cluster_number=${cluster_number} max_iter=${max_iter} dat_num=16
